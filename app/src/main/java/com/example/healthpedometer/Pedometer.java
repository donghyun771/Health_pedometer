...
//            //ask for permission
//            ActivityCompat.requestPermissions(new String[]{Manifest.permission.ACTIVITY_RECOGNITION}, PERMISSIONS_REQUEST);
//        }
...
//            final TextView text = (TextView) findViewById(R.id.main_stepcount);
